...
import org.fundacion.jala.converter.core.facade.strategy.compiles.JavaCompilerStrategy;
...
public class JavaCompilerController {
    ...
    public String compileJava(final @RequestParam("code") String code) {
        try {
            return CompilerFacade.callCompiler(new JavaCompilerStrategy(code));
